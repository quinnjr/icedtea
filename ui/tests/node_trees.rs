...
#[test]
fn grid_matches_its_gtk_fixture() {
    assert_fixture(
        icedtea_ui::view::Kind::Grid,
        &icedtea_ui::view::Props::default(),
        "grid",
    );
}
...
#[test]
fn paned_matches_its_gtk_fixture() {
    let mut props = icedtea_ui::view::Props::default();
    props.set(
        icedtea_ui::view::PropName::WideHandle,
        icedtea_ui::view::Prop::Bool(true),
    );
    assert_fixture(icedtea_ui::view::Kind::Paned, &props, "paned");
}
...
#[test]
fn overlay_matches_its_gtk_fixture() {
    assert_fixture(
        icedtea_ui::view::Kind::Overlay,
        &icedtea_ui::view::Props::default(),
        "overlay",
    );
}
...
#[test]
fn list_box_matches_its_gtk_fixture() {
    let mut props = icedtea_ui::view::Props::default();
    props.set(
        icedtea_ui::view::PropName::ShowSeparators,
        icedtea_ui::view::Prop::Bool(true),
    );
    assert_fixture(icedtea_ui::view::Kind::ListBox, &props, "list_box");
}
...
#[test]
fn popover_menu_bar_matches_its_gtk_fixture() {
    let mut props = icedtea_ui::view::Props::default();
    props.set(
        icedtea_ui::view::PropName::Menus,
        icedtea_ui::view::Prop::Classes(["File", "Edit"].iter().map(|s| (*s).into()).collect()),
    );
    assert_fixture(
        icedtea_ui::view::Kind::PopoverMenuBar,
        &props,
        "popover_menu_bar",
    );
}
